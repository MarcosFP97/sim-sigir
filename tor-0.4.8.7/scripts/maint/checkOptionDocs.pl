...
open(F, "/home/marcos.fernandez.pichel/PhD/sim-sigir/tor-0.4.8.7/src/app/tor --list-torrc-options |") or die;
while (<F>) {
...
loadTorrc("/home/marcos.fernandez.pichel/PhD/sim-sigir/tor-0.4.8.7/src/config/torrc.sample.in", \%torrcSampleOptions);

# Try to figure out what's in the man page.

my $considerNextLine = 0;
open(F, "/home/marcos.fernandez.pichel/PhD/sim-sigir/tor-0.4.8.7/doc/man/tor.1.txt") or die;
while (<F>) {
